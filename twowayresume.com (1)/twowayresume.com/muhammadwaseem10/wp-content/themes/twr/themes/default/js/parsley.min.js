/* Parsley dist/parsley.min.js build version 1.1.9-dev http://parsleyjs.org */ ! function(d) {
    var h = function(a) {
        this.messages = {
    ...
    h.prototype = {
        ...
        validators: {
            ...
            remote: function(a, b, c) {
                ...
                "undefined" !== typeof c.options.remoteDatatype && (e = {
                    dataType: c.options.remoteDatatype
                });
                var l = function(a) {
                    c.updateConstraint("remote", "isValid", a);
                ...
                d.ajax(d.extend({}, {
                    ...
                    data: f,
                    async: c.async,
                    method: c.options.remoteMethod || "GET",
                    success: function(a) {
                        l("1" === a || "true" == a || "object" === typeof a && "undefined" !== typeof a.success || /success/i.test(a))
                    },
                    error: function() {
                        l(!1)
                    }
        ...
        addMessage: function(a, b, c) {
            if ("undefined" !==
                typeof c && !0 === c) this.messages.type[a] = b;
            else if ("type" === a)
    ...
    j.prototype = {
        ...
        init: function(a, b) {
            ...
            this.isRequired = !1;
            this.constraints = [];
            "undefined" === typeof this.isRadioOrCheckbox && (this.isRadioOrCheckbox = !1, this.hash =
                this.generateHash(), this.errorClassHandler = this.options.errors.classHandler(a) || this.$element);
            this.ulErrorManagement();
            this.bindHtml5Constraints();
            this.addConstraints();
            this.constraints.length && this.bindValidationEvents()
        },
        ...
        addConstraints: function() {
            for (var a in this.options) a = a.toLowerCase(), "function" === typeof this.Validator.validators[a] && (this.constraints.push({
                name: a,
                requirements: this.options[a],
                isValid: null
            }), "required" === a && (this.isRequired = !0), this.addCustomConstraintMessage(a))
        },
        addCustomConstraintMessage: function(a) {
            var b = a + ("type" === a ? this.options[a].charAt(0).toUpperCase() + this.options[a].substr(1) : "") + "Message";
            "undefined" !== typeof this.options[b] && this.Validator.addMessage("type" === a ? this.options[a] : a, this.options[b], "type" === a)
        },
        bindValidationEvents: function() {
            this.$element.addClass("parsley-validated");
            var a = this.options.trigger + (/key/i.test(this.options.trigger) ? "" : " keyup");
            this.options.remote && (a += /change/i.test(a) ? "" : " change");
            if (a) this.$element.on((a + " ").split(" ").join("." + this.type + " "), !1, d.proxy(this.eventValidation, this))
        },
        ...
        eventValidation: function(a) {
            var b = this.getVal();
            if ("keyup" === a.type && !/keyup/i.test(this.options.trigger) && !this.validatedOnce || b.length < this.options.validationMinlength && !this.validatedOnce) return !0;
            this.validate(!0, !1)
        },
        isFieldValid: function() {
            return this.validate(!1, !1)
        },
        validate: function(a, b) {
            var c = this.getVal(),
                d = null;
            if (this.options.listeners.onFieldValidate(this.element, this) || "" === c && !this.isRequired) return this.reset(), null;
            if (!this.needsValidation(c)) return this.isValid;
            this.errorBubbling = "undefined" !== typeof a ? a : !0;
            this.async = "undefined" !== typeof b ? b : !0;
            d = this.applyValidators();
            this.errorBubbling && this.manageValidationResult();
            return d
        },
        ...
        applyValidators: function() {
            for (var a = null, b = 0; b < this.constraints.length; b++) {
                var c = this.Validator.validators[this.constraints[b].name](this.val, this.constraints[b].requirements, this);
                !1 === c ? (a = !1, this.constraints[b].isValid = a) : !0 === c && (this.constraints[b].isValid = !0, a = !1 !== a)
            }
            return a
        },
        updateConstraint: function(a, b, c) {
            for (var d = 0; d < this.constraints.length; d++)
                if (this.constraints[d].name === a) {
        ...
        manageValidationResult: function() {
            for (var a = null, b = 0; b < this.constraints.length; b++) !1 === this.constraints[b].isValid ? (this.addError(this.constraints[b]), a = !1) : !0 === this.constraints[b].isValid && (this.removeError(this.constraints[b].name), a = !1 !== a);
            this.isValid = a;
            return !0 === this.isValid ? (this.removeErrors(), this.errorClassHandler.removeClass(this.options.errorClass).addClass(this.options.successClass), this.options.listeners.onFieldSuccess(this.element, this.constraints, this), !0) : !1 === this.isValid ?
        ...
        removeError: function(a) {
            a = this.ulError + " ." + a;
            this.ulError && (d(a).remove() && 0 === d(this.ulError).children().length) && d(this.ulError).remove()
        },
        ...
        addError: function(a) {
            d(this.ulError).length || this.options.errors.container(this.element, this.ulTemplate, this.isRadioOrCheckbox) || (!this.isRadioOrCheckbox ? this.$element.after(this.ulTemplate) : this.$element.parent().after(this.ulTemplate));
            var b = a.name,
                c = !1 !== this.options.errorMessage ? "custom-error-message" : b,
                f = this.ulError + " ." + c,
                c = d(this.options.errors.errorElem).addClass(c);
            ...
            d(f).length || d(this.ulError).append(d(c).text(a))
        },
    ...
    m.prototype = {
        ...
        initMultiple: function(a, b) {
            ...
            this.$siblings = d(this.siblings);
            this.errorClassHandler = b.errors.classHandler(a) ||
                this.$element.parent()
        },
    ...
    k.prototype = {
        ...
        validate: function(a) {
            ...
            for (var c = 0; c < this.items.length; c++)
                if (!1 === this.items[c].validate() &&
                    (b = !1, !this.focusedField && "first" === this.options.focus || "last" === this.options.focus)) this.focusedField = this.items[c].$element;
    ...
    d.fn.parsley = function(a, b) {
        function c(c, e) {
            ...
            if (!g) {
                switch (e) {
                    case "parsleyForm":
                        g = new k(c, f, "parsleyForm");
                        break;
                    case "parsleyField":
                        g = new j(c, f, "parsleyField");
                        break;
                    case "parsleyFieldMultiple":
                        g = new m(c, f, "parsleyFieldMultiple");
                        break;
                    default:
                        return
                }
            ...
            return "string" === typeof a && "function" === typeof g[a] ? g[a](b) : g
        }
        var f = d.extend(!0, {}, d.fn.parsley.defaults, "undefined" !== typeof window.ParsleyConfig ? window.ParsleyConfig : {}, a, this.data()),
            e = null;
        d(this).is("form") ? e = c(d(this), "parsleyForm") : d(this).is(f.inputs) && !d(this).is(f.excluded) &&
            (e = c(d(this), !d(this).is("input[type=radio], input[type=checkbox]") ? "parsleyField" : "parsleyFieldMultiple"));
        return "function" === typeof b ? b() : e
    };
